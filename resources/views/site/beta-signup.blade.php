			...
			<div class="row align-items-center">
				<div class="col-sm-12 col-md-2 col-lg-1">
					<div class="rounded-circle">
			      		<img src="{{ asset('public/front/img/img5.png')}}" alt="" title="" class="img-fluid">
			      	</div>
				</div>
...
<section class="slider-sec">
  ...
  <div class="owl-carousel">
    <div class="item">
      <div class="lft-sec">
      	<div class="rounded-circle">
      		<img src="{{ asset('public/front/img/Mom.png')}}" alt="" title="" class="img-fluid">
      	</div>
      </div>
      <div class="rgt-sec">
      	<blockquote>
    ...
    <div class="item">
      <div class="lft-sec">
      	<div class="rounded-circle">
      		<img src="{{ asset('public/front/img/Couple.png')}}" alt="" title="" class="img-fluid">
      	</div>
      </div>
      <div class="rgt-sec">
      	<blockquote>
...
<script type="text/javascript" src="{{ asset('public/front/js/css3-animate-it.js')}}"></script>
