            ...
            <div class="container cart-items">
                ...
                <div class="row step_gift" id="prch-{{$purchase->id}}" >
                    ...
                    <div class="col-md-6 col-xs-12" style="margin:30px 0"  >
                        ...
                        <p><input class="purchase-amounts" value="{{$purchase->amount}}"></p>
                        </div>
                        <div class="col-md-3 text-center">
                          <p>$12 LEFT TO FULFILL GIFT</p>
                        </div>
                        <div class="col-md-3 text-center">
                            <button type="button" data-id="{{$purchase->id}}" class="close remove" aria-label="Close">
                                 <span aria-hidden="true">&times;<h6>REMOVE</h6></span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-xs-8 text-right">
                                <p>Make Your Gift Anonymous  <i class="fas fa-info-circle"></i></p>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-6 text-left" style="margin-top: -3px;">
                    <div class="pretty p-default p-round">
                        <div class="state">
                           <input id="check-payment" type="radio" name="radio1"><label><p style="margin-top: -9px;font-size: 18px;margin-bottom:0px"><strong>Check</strong></label></p>
                        </div>
                    </div>
                </div>    
            </div>
	...
	<div class="container">
		<div class="footer-top">
			<div class="row align-items-center">
				<div class="fheader col-sm-3 col-md-3 col-lg-3 col-xs-12">
